        ...
        <Card variant="elevated" padding="lg" style={styles.sessionCard}>
          ...
          >
            ...
            <View style={styles.sessionOptionInfo}>
              ...
              <Text style={styles.sessionOptionDesc}>Guided sequences with timer</Text>
            </View>
          ...
          >
            ...
            <View style={styles.sessionOptionInfo}>
              ...
              <Text style={styles.sessionOptionDesc}>Timer with breathing guide</Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <View style={styles.sessionOptionInfo}>
              ...
              <Text style={styles.sessionOptionDesc}>Work/rest intervals</Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </TouchableOpacity>
        </Card>
