...
export async function createGoal(data: CreateGoalRequest): Promise<ApiResponse<Goal>> {
  try {
...
export async function deleteGoal(id: string): Promise<ApiResponse<{ success: boolean }>> {
  try {
